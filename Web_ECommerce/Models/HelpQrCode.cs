...
namespace Web_ECommerce.Models
{
    public class HelpQrCode : Controller
    {
        ...
        /*public async Task<IActionResult> Download( IWebHostEnvironment _environment)
        {
            ...
            using (var doc = new PdfSharpCore.Pdf.PdfDocument())
            {
                ...
                detalhes.DrawString(compraUsuario.QuantidadeCandidatos.ToString(), tituloInfo_1, corFonte, new XRect(150, alturaTituloDetalhesY, page.Width, page.Height));
